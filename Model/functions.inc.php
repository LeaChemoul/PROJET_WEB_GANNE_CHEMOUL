<?php
    ...
    $query = "INSERT INTO creneau(idProf,dateDebut,duree,exclusivite,datePublic,libre,commentaireAvant,aEuLieu,commentaireApres,note) VALUES('$idProf','$date','$duree','$excl','$dateActuelle','$lib','$commentaireAvant','$aEuLieu','$commApres','$note') ";
        echo $query;
        if (mysqli_query($cnxDb,$query)){
